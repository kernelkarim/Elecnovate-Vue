<template>
  <div class="testimonial-card22-testimonial-card" v-bind:class="rootClassName">
    <div class="testimonial-card22-testimonial">
      <svg viewBox="0 0 1024 1024" class="testimonial-card22-icon">
        <path
      ...
      <span class="testimonial-card22-text">{{ quote }}</span>
      <span class="testimonial-card22-text1">{{ name }}</span>
    </div>
    <img :alt="profileAlt" :src="profileSrc" class="testimonial-card22-image" />
  </div>
</template>

<script>
export default {
  name: 'TestimonialCard22',
  props: {
    name: {
      type: String,
      default: 'John Doe',
