<template>
  <div class="testimonial-card43-testimonial-card" v-bind:class="rootClassName">
    <svg viewBox="0 0 1024 1024" class="testimonial-card43-icon">
      <path
    ...
    <span class="testimonial-card43-text">{{ quote }}</span>
    <div class="testimonial-card43-profile">
      <img :alt="pictureAlt" :src="pictureSrc" class="testimonial-card43-image" />
      <div class="testimonial-card43-container">
        <span class="testimonial-card43-text1">{{ name }}</span>
        <span class="testimonial-card43-text2">{{ role }}</span>
      </div>
    </div>
  </div>
</template>
