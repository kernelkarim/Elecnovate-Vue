<template>
  <div class="testimonial-card41-testimonial-card" v-bind:class="rootClassName">
    <svg viewBox="0 0 1024 1024" class="testimonial-card41-icon">
      <path
    ...
    <span class="testimonial-card41-text">{{ quote }}</span>
    <div class="testimonial-card41-profile">
      <img :alt="pictureAlt" :src="pictureSrc" class="testimonial-card41-image" />
      <div class="testimonial-card41-container">
        <span class="testimonial-card41-text1">{{ name }}</span>
        <span class="testimonial-card41-text2">{{ role }}</span>
      </div>
    </div>
  </div>
</template>
